...
Algo que no fue implementado por limitaciones de tiempo es el mecanismo señalado al final de la sección \ref{sect:diseno-extCont} para generar todos los posibles estados de las condiciones que se derivan de la forma normal conjuntiva. La forma de implementar de esto consiste en generar una lista de contextos de extracción, cada uno asociado a un posible estado según lo explicado, en lugar de un solo contexto. Luego al hacer la búsqueda focalizada se debe hacer con cada uno de los contextos de extracción y usar un mecanismo para discriminar cuál es la respuesta correcta. \\
