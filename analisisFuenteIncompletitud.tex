...
SUCH THAT estudiante.carrera = ‘Ingeniería de Computación’ OR estudiante.indice \textless 3 \\
}
...
\QUERY{		
LISTA estudiante.carnet INSTANCES
SUCH THAT (estudiante.carrera  is null) AND estudiante.indice \textless 3; (en la que se eliminó la condición sobre estudiante.carrera del or)\\
}
...
SUCH THAT \textless A is null, Calificación de la consulta con las condiciones sobre la lista de atributos L2\textgreater; \\
}
...
\QUERY{	
LIST \textless Clave del Concepto\textgreater INSTANCES \\
SUCH THAT \textless A is null, Calificación parcial de la consulta con las condiciones sobre L2-{Atributo A}\textgreater; \\
}
...
\QUERY{	
LIST \textless Clave del Concepto\textgreater INSTANCES \\
SUCH THAT \textless A is null, Calificación parcial de la consulta con condiciones sobre L2-{Atributo A}\textgreater; \\
}
...
\QUERY{	
LIST pais. nombre\_pais INSTANCES \\
...
\QUERY{	
LIST \textless Lista de atributos L1\textgreater INSTANCES \\
SUCH THAT \textless Condiciones sobre la lista de atributos L2, Subconsulta LIST \textless Lista de atributos L3\textgreater INSTANCES \\
...
\QUERY{	
LIST \textless Clave del Concepto\textgreater INSTANCES \\
SUCH THAT \textless A is null AND Calificación con las condiciones de consulta anidada y la lista de atributos L2\textgreater; \\
}

2)  Para cada atributo A perteneciente a L2: \\

\QUERY{	
LIST \textless Clave del Concepto, Atributo A\textgreater INSTANCES \\
SUCH THAT \textless A is null AND Calificación parcial de la consulta con las condiciones \\
de la consulta anidada-{Atributo A} U L2-{Atributo A}\textgreater;
}
...
\QUERY{	
LIST \textless Clave del Concepto\textgreater INSTANCES \\
SUCH THAT \textless A is null AND Calificación de la consulta con las condiciones sobre lista de atributos L4\textgreater; \\
}
...
\QUERY{	
LIST \textless Clave del Concepto\textgreater INSTANCES \\
SUCH THAT \textless A is null AND Calificación parcial de la consulta con las condiciones sobre la lista L4-{Atributo A}\textgreater; \\
}
...
AND (region.abreviacion like ‘A*’  or region.abreviacion like ‘L*’ ) AND region.continente = ‘AMERICA’;\\
}
...
SUCH THAT region.continente is null AND 100000 \textless (list region$^\wedge$pais.poblacion\_pais instances)\\ 
AND (region.abreviacion like ‘A*’  or region.abreviacion like ‘L* )\\
}

\QUERY{	
LIST region.nombre INSTANCES SUCH THAT \\
region.abreviacion is null AND 100000 \textless (list region$^\wedge$pais.poblacion\_pais instances) AND  region.continente = ‘AMERICA’; \\
}

\QUERY{	
3) LIST nombre\_pais, pais.poblacion INSTANCES;\\
}
...
\QUERY{	
LIST \textless Lista de atributos L0 de conceptos que son partes del agregado, Lista de atributos L1\textgreater INSTANCES \\
SUCH THAT \textless Calificación de la consulta con las condiciones sobre la lista de atributos L2\textgreater \\
}
...
\QUERY{	
LIST \textless Clave del Concepto parte del agregado\textgreater INSTANCES \\
SUCH THAT  \textless A is null AND Calificación de la consulta con condiciones sobre la lista de atributos L2\textgreater; \\
}

2) Para cada atributo A de L1 \\

\QUERY{	
LIST \textless Clave del Concepto sobre el que se hace la consulta\textgreater INSTANCES \\
SUCH THAT \textless A is null AND Calificación de la consulta con condiciones sobre la lista de atributos L2\textgreater; \\
}
...
\QUERY{	
LIST \textless Clave del Concepto sobre el que se hace la consulta\textgreater INSTANCES \\
SUCH THAT \textless A is null AND Calificación parcial de la consulta con condiciones sobre L2-{Atributo A}\textgreater; \\
}
